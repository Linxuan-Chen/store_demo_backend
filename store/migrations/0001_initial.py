    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='store.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('promotions', models.ManyToManyField(blank=True, null=True, to='store.promotions')),
            ],
        ),
        migrations.AddField(
